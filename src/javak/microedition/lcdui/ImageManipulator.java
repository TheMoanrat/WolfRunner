...
//# 	private int[] regionXPts = { 0, 0, 0, 0 };
//# 	private int[] regionYPts = { 0, 0, 0, 0 };
//# 
...
//# 			rotation = VecMath.multiplyPoint(transformMatrix, 0, 0, 0);
...
//# 			// on all sides
//# 			resultantScaleX = Fixed32.div(bitmapRight, Fixed32.toFP(bitmap.getWidth()));
//# 			resultantScaleY = Fixed32.div(bitmapBottom, Fixed32.toFP(bitmap.getHeight()));
//# 
//# 		} else {
...
//# 	}
//#     
//# 	public void applyTransformation(int _iX, int _iY) {
//# 
//# 		// Check if this is necessary
//# 		if (transformationApplied) {
//# 			return;
...
//# 		int iH = Fixed32.toFP(bitmap.getHeight());
//# 
//# 		// scale the image size as requested
//# 		iW = Fixed32.mul(iW, scaleX);
//# 		iH = Fixed32.mul(iH, scaleY);
//# 
//# 		// init matrix
//# 		bitmapXPts[0] = 0;
//# 		bitmapYPts[0] = 0;
...
//# 			// scale the texture so that it is 2 pixels larger than the region
//# 			// on all sides
//# 			resultantScaleX = Fixed32.div((iW + Fixed32.toFP(4)), Fixed32.toFP(bitmap.getWidth()));
//# 			resultantScaleY = Fixed32.div((iH + Fixed32.toFP(4)), Fixed32.toFP(bitmap.getHeight()));
//# 
//# 		} else {
//# 			// orthogonal roations can use exact coordinates since the region is
//# 			// perfectly formed
//# 			textureX = bitmapXPts[0]-_iX;
//# 			textureY = bitmapYPts[0]-_iY;
//# 			resultantScaleX = scaleX;
//# 			resultantScaleY = scaleY;
//# 		}
//# 		// set the resulting dimensions of a bitmap containing this rotation
...
//# 		g.drawTexturedPath(bitmapXPts, bitmapYPts, null, null, textureX, textureY, dux, dvx, duy, dvy, bitmap);		
//# 
//# 	}
//# 
//# 	/**
