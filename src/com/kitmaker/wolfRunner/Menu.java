...
//                + (GfxManager.ms_vImage[GfxManager.GFXID_MENU_BUTTONS].getHeight()>>2));
    ...
    public static void Run() {
        ...
        if (!ms_bSelected) {
            ...
            if (Main.GameKeyPressed(Main.KEYINT_UP, true)
                ...
                } else if (Main.GameKeyPressed(Main.KEYINT_RIGHT, true)
    ...
    public static void Draw(Graphics _g) {
        ...
        if (ms_iTitleTxtID != -1) {
            ...
            _g.drawImage(GfxManager.ms_vImage[GfxManager.GFXID_TITLE_HEADER], Define.SIZEX2, iAddY + (iAddH >> 1), Graphics.VCENTER | Graphics.HCENTER);

            FntManager.DrawFont(_g, FntManager.FONT_TITLE, ms_vTitle[ms_iTitleTxtID],
    ...
    static void DrawNavigationIcons(Graphics _g, int _iSKLeft, int _iSKRight) {
        ...
        if (_iSKLeft == Define.SK_OK) {
            _g.setClip(0,
                    Define.SIZEY - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_HEIGHT],
                    GfxManager.SPRITE_DATA[GfxManager.SK_MENU[0]][GfxManager.SPR_WIDTH],
                    GfxManager.SPRITE_DATA[GfxManager.SK_MENU[0]][GfxManager.SPR_HEIGHT]);

            if (Main.GameKeyPressed(Main.KEYINT_SKLEFT, false)) {
                _g.drawImage(GfxManager.ms_vImage[GfxManager.GFXID_SK_MENU],
                        0,
                        Define.SIZEY - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[1]][GfxManager.SPR_POS_Y] - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[1]][GfxManager.SPR_HEIGHT],
                        0);
            } else {
                _g.drawImage(GfxManager.ms_vImage[GfxManager.GFXID_SK_MENU],
                        0,
                        Define.SIZEY - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[0]][GfxManager.SPR_POS_Y] - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[0]][GfxManager.SPR_HEIGHT],
                        0);
            }
        }
        ...
        if (_iSKRight == Define.SK_BACK) {
            _g.setClip(Define.SIZEX - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_WIDTH],
                    Define.SIZEY - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_HEIGHT],
                    GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_WIDTH],
                    GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_HEIGHT]);

            if (Main.GameKeyPressed(Main.KEYINT_SKRIGHT, false)) {
                _g.drawImage(GfxManager.ms_vImage[GfxManager.GFXID_SK_MENU],
                        Define.SIZEX - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[3]][GfxManager.SPR_WIDTH] - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[3]][GfxManager.SPR_POS_X],
                        Define.SIZEY - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[3]][GfxManager.SPR_HEIGHT] - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[3]][GfxManager.SPR_POS_Y],
                        0);
            } else {
                _g.drawImage(GfxManager.ms_vImage[GfxManager.GFXID_SK_MENU],
                        (Define.SIZEX - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_WIDTH]) - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_POS_X],
                        (Define.SIZEY - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_HEIGHT]) - GfxManager.SPRITE_DATA[GfxManager.SK_MENU[2]][GfxManager.SPR_POS_Y],
                        0);
            }
        }
