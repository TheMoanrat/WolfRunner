...
//#                                 SndManager.ms_iSoundVolumeIndex = Menu.ms_iSubOption[Menu.ms_iMarkedOption];
    ...
    static void Draw(javak.microedition.lcdui.Graphics _g) {
        switch (Define.ms_iState) {
            ...
            case Define.ST_INIT_LANGUAGE:
                ...
                Menu.Draw(_g);
                Menu.DrawNavigationIcons(_g, Define.SK_OK, Define.SK_NO_ICON);
                break;
            ...
            case Define.ST_MENU_LANGUAGE:
                drawMenuBackground(_g);
                Menu.Draw(_g);
                Menu.DrawNavigationIcons(_g, Define.SK_OK, Define.SK_BACK);
                break;
            ...
            // ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd
            case Define.ST_MENU_ABOUT:
                Menu.DrawNavigationIcons(_g, Define.SK_NO_ICON, Define.SK_BACK);
                break;
    ...
    public static void drawMenuBackground(Graphics g) {
        g.setClip(0, 0, Define.SIZEX, Define.SIZEY);
        g.drawImage(GfxManager.ms_vImage[GfxManager.GFXID_MENU_BACKGROUND], 0, 0, 0);
        g.setClip(0, 0, Define.SIZEX, Define.SIZEY);
    }
    ...
    public static void LoadMenuImages(boolean _bShowLoadingBar) {
        ...
        GfxManager.AddGraphic(GfxManager.GFXID_MENU_BACKGROUND);
        GfxManager.AddGraphic(GfxManager.GFXID_TITLE_HEADER);
        switch (Define.ms_iState) {
