...
//#         return src;
    ...
    /*
    static int GetSpriteWidth (int _iSprID) {
        return SPRITE_DATA[_iSprID][3];
    }
    static int GetSpriteHeight (int _iGfxID) {
        return SPRITE_DATA[_iSprID][4];
    }
    */
...
//#                     if (((destPixels[srcW-1-iX] >> 24) & 0xFF) != 0)
                    //#else
